...
const MONITORING_KEYWORDS = [
  ...
  // 크리에이터 이름
  '싸이코드', 'psy_chord', 'PSY_CHORD', 'psychord',
  '루이쨘', 'louiszzan', '루이짠',
  '감제이', '9jayaj9', 'gamjay',
  '연이', 'yeon2vt', '연이버튜버',
...
// PSY_CHORD 채널 정보
const CHANNELS = [
  { name: '루이쨘', handle: '@louiszzan', youtubeUrl: 'https://www.youtube.com/@louiszzan', chzzkUrl: '' },
  { name: '감제이', handle: '@9jayaj9', youtubeUrl: 'https://www.youtube.com/@9jayaj9', chzzkUrl: '' },
  { name: '연이', handle: '@yeon2vt', youtubeUrl: 'https://www.youtube.com/@yeon2vt', chzzkUrl: '' },
  { name: '하루토', handle: '@psy_haruto', youtubeUrl: 'https://www.youtube.com/@psy_haruto', chzzkUrl: '' },
  { name: '늦잠', handle: '@oversleepZzz', youtubeUrl: 'https://www.youtube.com/@oversleepZzz', chzzkUrl: '' }
];

function PsyChordDetail() {
  ...
  const loadAllChannelsData = async () => {
    ...
    try {
      ...
      // 전체 PSY_CHORD 채널 데이터를 한 번에 가져오기
      const response = await fetch(`/api/psy-chord/channel?_t=${timestamp}`, {
        cache: 'no-cache',
        headers: {
  ...
  return (
    <div className="psy-chord-detail-page" style={{
      padding: '20px',
      maxWidth: '1400px',
      margin: '0 auto',
      minHeight: '100vh',
      ...
      <div className="dashboard-header" style={{
        ...
        borderRadius: '16px',
        marginBottom: '32px',
        boxShadow: '0 8px 24px rgba(155, 89, 182, 0.25)',
        color: 'white',
        position: 'relative',
        overflow: 'hidden'
      }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: '300px' }}>
              ...
              <p style={{
                ...
                {CHANNELS.length}명의 크리에이터 (루이쨘, 감제이, 연이, 하루토, 늦잠) 수집 및 분석 데이터
              </p>
            </div>
            <button
              className="btn-back"
                ...
                <div style={{ marginTop: '20px' }}>
                  <button
                    ...
                    style={{
                      width: '100%',
                      padding: '12px',
                      background: isExpanded ? '#9b59b6' : '#f8f9fa',
                      color: isExpanded ? 'white' : '#9b59b6',
                ...
                <div className="channel-analysis" style={{
                  ...
                  {channel.comment_samples && channel.comment_samples.length > 0 && (
                    <div style={{
                      ...
                      <div style={{ fontSize: '14px', fontWeight: 'bold', marginBottom: '16px', color: '#9b59b6' }}>
                        🔍 모니터링 키워드 분석
                      </div>
                      {(() => {
                        const keywordFreq = {};
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                      {videos.slice(0, videoLimit).map((video, idx) => (
                                        ...
                                        >
                                          ...
                                          <span style={{ color: '#9b59b6', fontSize: '16px' }}>→</span>
                                        </a>
                                      ))}
                                      {hasMoreVideos ? (
                                        <button
